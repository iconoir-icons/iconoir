...
class PlaystationGamepad extends StatelessWidget {
  ...
  const PlaystationGamepad({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M16 4V6C16 7.10457 15.1046 8 14 8H10C8.89543 8 8 7.10457 8 6L8 4" stroke="currentColor"  stroke-linecap="round" stroke-linejoin="round"/>
