...
class AdobeLightroomSolid extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const AdobeLightroomSolid({Key? key, this.color, this.width, this.height})
      : super(key: key);
