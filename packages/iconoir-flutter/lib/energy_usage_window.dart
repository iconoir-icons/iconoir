...
class EnergyUsageWindow extends StatelessWidget {
  ...
  const EnergyUsageWindow({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M11.6667 11L10 14H14L12.3333 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
''',
        color: color,
        width: width,
