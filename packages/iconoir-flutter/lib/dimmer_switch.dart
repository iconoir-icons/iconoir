...
class DimmerSwitch extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const DimmerSwitch({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M15.5 7.5L12 12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
''',
        colorFilter:
