...
class PizzaSlice extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const PizzaSlice({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M6 19L2.23626 3.0041C2.13087 2.55618 2.54815 2.16122 2.98961 2.29106L19 7" stroke="currentColor" stroke-width="1.5"/>
