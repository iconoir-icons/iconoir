...
class EcologyBook extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const EcologyBook({Key? key, this.color, this.width, this.height})
      : super(key: key);
