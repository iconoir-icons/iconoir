...
class ArrowDownCircleSolid extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const ArrowDownCircleSolid({Key? key, this.color, this.width, this.height})
      : super(key: key);
