...
class ViewStructureDown extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const ViewStructureDown({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M3 20.4V14.6C3 14.2686 3.26863 14 3.6 14H20.4C20.7314 14 21 14.2686 21 14.6V20.4C21 20.7314 20.7314 21 20.4 21H3.6C3.26863 21 3 20.7314 3 20.4Z" stroke="currentColor" stroke-width="1.5"/>
