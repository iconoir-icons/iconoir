...
class GlassHalfAlt extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const GlassHalfAlt({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M4 13C5.03151 14.2034 7.92505 14.8638 11 14.981C14.7388 15.1236 18.7458 14.4632 20 13" stroke="currentColor" stroke-width="1.5"/>
