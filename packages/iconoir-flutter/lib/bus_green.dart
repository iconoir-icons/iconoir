...
class BusGreen extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const BusGreen({Key? key, this.color, this.width, this.height})
      : super(key: key);
...
<path d="M21 12H3V19C3 19.5523 3.44772 20 4 20H13" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
