...
class CheckCircleSolid extends StatelessWidget {
  final Color? color;
  final double? width;
  final double? height;

  const CheckCircleSolid({Key? key, this.color, this.width, this.height})
      : super(key: key);
