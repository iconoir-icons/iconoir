...
function SvgPageEdit(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M17.954 16.94l1-1a1.121 1.121 0 011.586 0v0a1.121 1.121 0 010 1.585l-1 1m-1.586-1.586l-2.991 2.991a1 1 0 00-.28.553l-.244 1.557 1.557-.243a1 1 0 00.553-.28l2.99-2.992m-1.585-1.586l1.586 1.586"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
