...
export const ShieldUpload = forwardRef(
  ({ color = 'currentColor', size = 24 }, ref) => {
    return (
      ...
      >
        ...
        >
          <path
            d="M12 15V8M12 8L15 11M12 8L9 11"
            stroke="currentColor"
            stroke-width="1.5"
...
ShieldUpload.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

ShieldUpload.displayName = 'ShieldUpload';

export default ShieldUpload;
