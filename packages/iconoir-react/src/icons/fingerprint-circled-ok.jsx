...
export const FingerprintCircledOk = forwardRef(
...
FingerprintCircledOk.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

FingerprintCircledOk.displayName = 'FingerprintCircledOk';

export default FingerprintCircledOk;
