...
export const PanoramaEnlarge = forwardRef(
...
PanoramaEnlarge.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

PanoramaEnlarge.displayName = 'PanoramaEnlarge';

export default PanoramaEnlarge;
