...
export const TowerCheck = forwardRef(
...
TowerCheck.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

TowerCheck.displayName = 'TowerCheck';
