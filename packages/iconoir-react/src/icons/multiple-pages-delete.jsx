...
export const MultiplePagesDelete = forwardRef(
  ({ color = 'currentColor', size = 24 }, ref) => {
    return (
      ...
      >
        ...
        >
          <path
            d="M2.87132 21.1213L4.99264 19M7.11396 16.8787L4.99264 19M4.99264 19L2.87132 16.8787M4.99264 19L7.11396 21.1213"
            stroke="currentColor"
            stroke-width="1.5"
...
MultiplePagesDelete.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MultiplePagesDelete.displayName = 'MultiplePagesDelete';

export default MultiplePagesDelete;
