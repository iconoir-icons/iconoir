...
export const PageStar = forwardRef(
  ({ color = 'currentColor', size = 24 }, ref) => {
    return (
      ...
      >
        ...
        >
          <path
            d="M20 12V5.74853C20 5.5894 19.9368 5.43679 19.8243 5.32426L16.6757 2.17574C16.5632 2.06321 16.4106 2 16.2515 2H4.6C4.26863 2 4 2.26863 4 2.6V21.4C4 21.7314 4.26863 22 4.6 22H11M8 10H16M8 6H12M8 14H11"
            stroke="currentColor"
            stroke-width="1.5"
