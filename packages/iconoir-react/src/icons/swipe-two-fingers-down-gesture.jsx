...
export const SwipeTwoFingersDownGesture = forwardRef(
...
SwipeTwoFingersDownGesture.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

SwipeTwoFingersDownGesture.displayName = 'SwipeTwoFingersDownGesture';

export default SwipeTwoFingersDownGesture;
