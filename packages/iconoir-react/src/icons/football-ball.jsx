...
export const FootballBall = forwardRef(
...
FootballBall.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

FootballBall.displayName = 'FootballBall';
