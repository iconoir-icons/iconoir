...
export const MoreHorizCircledOutline = forwardRef(
...
MoreHorizCircledOutline.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MoreHorizCircledOutline.displayName = 'MoreHorizCircledOutline';

export default MoreHorizCircledOutline;
