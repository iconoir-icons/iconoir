...
export const RemoveDatabaseScript = forwardRef(
...
RemoveDatabaseScript.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

RemoveDatabaseScript.displayName = 'RemoveDatabaseScript';

export default RemoveDatabaseScript;
