...
export const MapsTurnLeft = forwardRef(
    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M5 6.5H8C8 6.5 8 6.5 8 6.5C8 6.5 12 6.5 12 10.5M5 6.5L8.5 9M5 6.5L8.5 4"
            stroke="black"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
...
MapsTurnLeft.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MapsTurnLeft.displayName = 'MapsTurnLeft';

export default MapsTurnLeft;
