...
export const MultiplePagesEmpty = forwardRef(
...
MultiplePagesEmpty.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MultiplePagesEmpty.displayName = 'MultiplePagesEmpty';

export default MultiplePagesEmpty;
