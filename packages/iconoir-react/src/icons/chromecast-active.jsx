...
export const ChromecastActive = forwardRef(
...
ChromecastActive.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

ChromecastActive.displayName = 'ChromecastActive';

export default ChromecastActive;
