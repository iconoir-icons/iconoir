...
export const MultiplePagesRemove = forwardRef(
...
MultiplePagesRemove.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MultiplePagesRemove.displayName = 'MultiplePagesRemove';

export default MultiplePagesRemove;
