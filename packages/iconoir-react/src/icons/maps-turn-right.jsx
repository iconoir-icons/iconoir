...
export const MapsTurnRight = forwardRef(
    ...
    return (
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M19 6.5H16C16 6.5 16 6.5 16 6.5C16 6.5 12 6.5 12 10.5M19 6.5L15.5 9M19 6.5L15.5 4"
            stroke="black"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
...
MapsTurnRight.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MapsTurnRight.displayName = 'MapsTurnRight';

export default MapsTurnRight;
