...
export const FingerprintSquared = forwardRef(
...
FingerprintSquared.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

FingerprintSquared.displayName = 'FingerprintSquared';

export default FingerprintSquared;
