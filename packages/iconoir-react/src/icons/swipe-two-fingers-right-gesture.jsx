...
export const SwipeTwoFingersRightGesture = forwardRef(
...
SwipeTwoFingersRightGesture.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

SwipeTwoFingersRightGesture.displayName = 'SwipeTwoFingersRightGesture';

export default SwipeTwoFingersRightGesture;
