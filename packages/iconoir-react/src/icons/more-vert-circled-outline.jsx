...
export const MoreVertCircledOutline = forwardRef(
...
MoreVertCircledOutline.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

MoreVertCircledOutline.displayName = 'MoreVertCircledOutline';

export default MoreVertCircledOutline;
