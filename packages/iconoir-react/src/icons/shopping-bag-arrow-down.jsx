...
export const ShoppingBagArrowDown = forwardRef(
...
ShoppingBagArrowDown.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

ShoppingBagArrowDown.displayName = 'ShoppingBagArrowDown';

export default ShoppingBagArrowDown;
