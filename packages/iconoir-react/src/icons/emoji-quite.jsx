...
export const EmojiQuite = forwardRef(
  ({ color = 'currentColor', size = 24 }, ref) => {
    return (
      ...
      >
        ...
        >
          <path
            d="M9 15H15M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z"
            stroke="currentColor"
            stroke-width="1.5"
...
EmojiQuite.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

EmojiQuite.displayName = 'EmojiQuite';

export default EmojiQuite;
