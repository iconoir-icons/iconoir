...
export const BubbleUpload = forwardRef(
...
BubbleUpload.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

BubbleUpload.displayName = 'BubbleUpload';

export default BubbleUpload;
