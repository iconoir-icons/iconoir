...
export const CATEGORIES = [
  "3D Editor", "Actions", "Activities", "Animations", "Animals",
  "Audio", "Buildings", "Business", "Cloud", "Clothing", "Communication",
  "Connectivity", "Database", "Design Tools", "Development", "Devices",
  "Docs", "Editor", "Finance", "Food", "Gaming", "Gestures", "Health",
  "Home", "Identity", "Layout", "Maps", "Music", "Nature", "Navigation",
  "Organization", "Other", "Photos and Videos", "Science", "Security",
  "Shapes", "Shopping", "Social", "System", "Tools", "Transport",
  "Typography", "Users", "Weather",
] as const;
